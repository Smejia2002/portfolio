  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-32 left-32 w-40 h-40 border border-emerald-600 transform rotate-45"></div>
        <div className="absolute bottom-32 right-32 w-32 h-32 border border-emerald-700 transform -rotate-12"></div>
        <div className="absolute top-64 right-64 w-24 h-24 border border-emerald-500 transform rotate-30"></div>
      </div>
