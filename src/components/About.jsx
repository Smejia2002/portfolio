  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-40 left-20 w-40 h-40 border border-emerald-600 transform rotate-45"></div>
        <div className="absolute bottom-60 left-40 w-24 h-24 border border-emerald-700 transform -rotate-12"></div>
        <div className="absolute top-80 left-80 w-16 h-16 border border-emerald-500 transform rotate-30"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative hidden lg:block">
            <div className="relative mx-auto w-96 h-96">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-emerald-700/20 via-emerald-600/20 to-emerald-800/20 rounded-3xl p-8">
                {/* Círculos concéntricos animados */}
                <div className="relative w-full h-full flex items-center justify-center">
                  {/* Círculo exterior */}
                  <div className="absolute w-80 h-80 border-2 border-emerald-500/30 rounded-full animate-spin-slow"></div>

                  {/* Círculo medio */}
                  <div className="absolute w-60 h-60 border-2 border-emerald-600/40 rounded-full animate-reverse-spin"></div>

                  {/* Círculo interior */}
                  <div className="absolute w-40 h-40 border-2 border-emerald-700/50 rounded-full animate-pulse"></div>

                  {/* Centro con ícono */}
                  <div className="relative z-10 w-20 h-20 bg-gradient-to-tr from-emerald-700 to-emerald-900 rounded-full flex items-center justify-center">
                    <svg
                  ...
                  {/* Puntos flotantes */}
                  <div className="absolute top-4 right-8 w-3 h-3 bg-emerald-500 rounded-full animate-ping"></div>
                  <div className="absolute bottom-8 left-4 w-2 h-2 bg-emerald-600 rounded-full animate-ping delay-300"></div>
                  <div className="absolute top-16 left-8 w-1 h-1 bg-emerald-400 rounded-full animate-pulse delay-700"></div>
                </div>
              </div>
            </div>
          </div>
