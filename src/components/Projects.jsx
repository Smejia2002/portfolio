function Projects() {
  ...
  const projects = [
    {
      id: 1,
      title: "Proyecto Principal 1",
      description: "Descripción detallada de tu primer proyecto de alto valor. Aquí explicarás las tecnologías usadas y el impacto generado.",
      image: "/api/placeholder/400/250", // Placeholder temporal
      technologies: ["React", "Node.js", "MongoDB", "Tailwind"],
      category: "fullstack",
      github: "#", // Tu link de GitHub
      demo: "#",   // Tu link de demo
      status: "completed"
    },
    {
      id: 2,
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                {/* Overlay con enlaces (solo para proyectos completados) */}
                {project.status === 'completed' && (
                  <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 
                                  transition-opacity duration-300 flex items-center justify-center space-x-4">
                    <a
                      href={project.github}
                      className="p-3 bg-gray-900 rounded-full text-white hover:bg-purple-600 transition-colors"
                      target="_blank"
                    ...
                    <a
                      href={project.demo}
                      className="p-3 bg-gray-900 rounded-full text-white hover:bg-blue-600 transition-colors"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
